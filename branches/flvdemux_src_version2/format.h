#ifndef __AVFORMAT_H_
#define __AVFORMAT_H_
...
enum FileFormatID{
    FILEFORMAT_ID_NONE,
    FILEFORMAT_ID_FLV,
    FILEFORMAT_ID_F4V = FILEFORMAT_ID_FLV,
    FILEFORMAT_ID_MP4,
    FILEFORMAT_ID_MOV = FILEFORMAT_ID_MP4,
    FILEFORMAT_ID_TS,
    FILEFORMAT_ID_MKV,
    FILEFORMAT_ID_MP3,
    FILEFORMAT_ID_ASF,
    FILEFORMAT_ID_WMA = FILEFORMAT_ID_ASF,
    FILEFORMAT_ID_WMV = FILEFORMAT_ID_ASF,
    FILEFORMAT_ID_AVI,
    FILEFORMAT_ID_RMVB,
    FILEFORMAT_ID_MPG,
    FILEFORMAT_ID_PMP,
